		...
		<div class="col-md-8">
			     ...
			     <div class="panel panel-default">
					 ...
					 <?php 
						...
						$query="select * from products where title='MAFIA III'";
						$result=mysqli_query($con,$query) or die(mysqli_error());
						while($row=mysqli_fetch_assoc($result)){
					?>
							
							<p style="color:yellow; background-color:#333300; text-align:center;"><?php echo $row["title"]; ?><br><br></p>
